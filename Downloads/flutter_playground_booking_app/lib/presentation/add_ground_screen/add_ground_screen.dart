      ...
      onPressed: () {
        setState(() {
          ...
          controller.addGroundModelObj.update((model) {
            model?.listofGrounds = List.from(listOfGrounds); // Update the list in the model
          });
          print('Updated list of grounds in view: $listOfGrounds');
          print('Updated list of grounds in controller: ${controller.addGroundModelObj.value.listofGrounds}');
        });
        // Clear the fields after adding
        groundNameController.clear();
        groundTimeController.clear();
