...
//         // await prefs.setInt('selectedTurfId', turfId ?? 0);
...
//         await prefs.setInt('selectedTurfId', 18); // Fallback value if id is null
//       }
//         Get.toNamed(AppRoutes.detailScreen, arguments: turfId);
//         print('turf id saved');
//         // Get.toNamed(AppRoutes.detailScreen , arguments: populargroundItemModelObj.id);
//       },
//       child: Container(
