        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(padding: EdgeInsets.all(10.h), child: Text('Rate the review :' , style: TextStyle(fontSize: 14, color: Colors.black, fontWeight: FontWeight.bold)),),
              Padding(padding: EdgeInsets.only(left: 10.h) , child: RatingBar.builder(
                      initialRating: 0,
                      minRating: 1,
