...
//                                       color:
//                                           appTheme.whiteA700.withOpacity(0.20)),
//                                   child: Padding(
...
//                                         ? CustomImageView(
//                                             imagePath:controller.eventDetail!.image,
//                                                 // controller.eventDetail!.image!,
...
//                                     // imagePath: controller.imageUrls[index],
...
//                                   shrinkWrap: true,
//                                   itemCount:
//                                       controller.previouseMemory.length > 4
//                                           ? 4
//                                           : controller.previouseMemory.length,
//                                   gridDelegate:
...
//                                   itemBuilder: (context, index) {
//                                     EventsdetailItemModel model =
//                                         controller.previouseMemory[index];
...
// }
import 'package:expandable_text/expandable_text.dart';
import 'package:flutter_playground_booking_app/presentation/events_detail_screen/widgets/eventsdetail_item_widget.dart';
import 'controller/events_detail_controller.dart';
import 'models/eventsdetail_item_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_playground_booking_app/core/app_export.dart';
        ...
        body: SafeArea(
          child: Obx(() {
            if (controller.loading.value) {
              ...
              return GetBuilder<EventsDetailController>(
                builder: (controller) => Stack(
                  children: [
                    Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                                  ...
                                  ListView(
                                    ...
                                    children: [
                                      ...
                                      GridView.builder(
                                        primary: false,
                                        shrinkWrap: true,
                                        itemCount: controller.previouseMemory.length > 4
                                            ? 4
                                            : controller.previouseMemory.length,
