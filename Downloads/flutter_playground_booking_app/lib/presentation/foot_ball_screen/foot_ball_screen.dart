                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  buildSeventeen(
                                    image: model.turfImage.toString(), // Ensure image is used correctly
                                    distance: model.price ?? '',
                                  ),
                                  SizedBox(height: 12.v),
                                  Padding(
...
//                                 children: [
//                                   buildSeventeen(
//                                     image: model.turfImage?.toString() ?? '', // Handle null value
//                                     distance: model.price ?? '',
//                                   ),
//                                   SizedBox(height: 12.v),
//                                   Padding(
...
//                                 children: [
//                                   buildSeventeen(
//                                     image: model.turfImage.toString(), // Assuming turfImage is a URL or path
//                                     distance: model.price ?? '',
//                                   ),
//                                   SizedBox(height: 12.v),
//                                   Padding(
